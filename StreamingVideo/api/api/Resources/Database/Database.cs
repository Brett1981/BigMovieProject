    ...
    public class Database
    {
        ...
        public static class Movie
        {
            ...
            internal static async Task<Movie_Data> Edit(string guid, System.Web.Mvc.FormCollection collection)
            {
                try
                {
                    var movie = await Database.Movie.Get(guid);
            ...
            public static async Task<Movie_Data> GetMovie(string guid, bool isPlay = false)
            {
        ...
        public static class User
        {
            ...
            /// <returns></returns>
            public static async Task<string> ChangeUserPicture(Auth.Auth.User user)
            {
            ...
            public static async Task<Object> CreateSession<T>(DatabaseUserModels data)
            {
                ...
                if (isGuest)
                {
                    var s = new Session_Guest()
                    {
                        ...
                        session_id = Movie.CreateGuid(result.ToString()).ToString(),
